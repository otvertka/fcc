...
//   let arrCopy = arr.slice(); // Create a shallow copy of the input array
...
// LEC  Use the every Method to Check that Every Element in an Array Meets a Criteria
...
// LEC  Use the some Method to Check that Any Elements in an Array Meet a Criteria
// function checkPositive(arr) {
...
// LEC Introduction to Currying and Partial Application
// function curried(x) {
//   return function (y) {
//     return x + y;
//   };
...
// const partialFn = add.bind(this, 2);
...
// LEC Sum All Numbers in a Range
// function sumAll(arr) {
//   let sum = 0;
...
// LEC Seek and Destroy
// function destroyer(arr) {
//   let args = Array.from(arguments).slice(1); // Преобразуем arguments в массив, исключая первый элемент (arr)
//   console.log(args);

//   const uniq = arr.filter((elem) => !args.includes(elem));
//   return uniq;
// }

// console.log(destroyer([1, 2, 3, 1, 2, 3], 2, 3)); // should return [1, 1].

// LEC Wherefore art thou
...
// LEC Search and Replace
// function myReplace(str, before, after) {
//   let newStr = str.replace(before, after[0].toUpperCase() + after.slice(1));
//   return newStr;
// }
...
function myReplace(str, before, after) {
  ...
  newStr = str.replace(new RegExp(before, "gi"), after);
  return newStr;
}
