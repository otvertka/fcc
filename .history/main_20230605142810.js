...
function getRating(watchList) {
  ...
  averageRating = filteredList.reduce(
    (accum, currentVal) => accum + currentVal.rating
  );
  // nolanObj = filteredList.reduce((obj, film) => {
  //   obj[film.title] = +film.rating;
  //   return obj;
  // }, {});
  // console.log(nolanObj);

  // averageRating = nolanObj.reduce((accum, film) => {
  //   return accum + film;
  // });
  console.log(averageRating);

  // watchList.reduce((obj, film) => {

  //   obj[film.Title] = film.imdbRating;
